...
WHEN NO QUERY — provide a README summary (one entry per README file):
...
- **`scripts/find-readmes.py`** — Locates all README files recursively across the repository; prints the output path + file list
